    ...
    return (
        <div className="home-banner"  data-aos="fade-in">
            <div className="home-banner__image" >
                ...
                <ImageWithFallback src={data.image_mobile ? process.env.NEXT_PUBLIC_ASSET_URL + data.image_mobile : '/imgs/Image-banner-with-product.jpg'} alt={data.title} fill className="block md:hidden" />
            </div>
